...
import com.joe.podcastplayer.UserPreferences;
...
public class ExoPlayerWrapper implements IPlayer {
    ...
    private String encodeCredentials(String username, String password, String charset) {
        try {
    ...
    @Override
    public void initMediaPlayer(@NotNull Context context) {
